    ...
    with tqdm(
        ...
        for filename in filenames:
            ...
            if filename.lower().endswith(f".{output_format}"):
                ...
                shutil.copy(
                    input_path,
                    os.path.join(output_dir, f"{unique_name}{original_extension}"),
                )
            else:
...
convert_images_in_dir(
    "Database\\Train\\Data\\train\\NORMAL",
    "Database\\Train\\Data\\train\\NORMAL_NEW",
    "jpeg",
)
print("PNEUMONIA conv...")
convert_images_in_dir(
    "Database\\Train\\Data\\train\\PNEUMONIA_NEW",
    "Database\\Train\\Data\\train\\PNEUMONIA_NEW",
    "jpeg",
)
print("done.")
